...
o_stepReturn = 0;
// }} ""
// {{ 248 1 0 "53a14975_dd73_4964_8c8c9f0730a43a7a" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
onerror goto errLabel_ABA9DAA34A59470495CBB56841D2D81D ;
err.Clear();
// }} ""
// {{ 249 1 0 "285b84de_748a_400d_a828988b60f4c175" "ML_STAR:{CC819D7A-5DD8-4d13-A921-D74A06460F9E}"
{
	variable arrRetValues[];
...
// }} ""
// {{ 250 1 0 "53a14975_dd73_4964_8c8c9f0730a43a7a" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
errLabel_ABA9DAA34A59470495CBB56841D2D81D : {}
onerror goto 0;
if (err.GetId() != 0)   /* skip handler if no error */
{
// }} ""
// {{{ 251 1 0 "298cdb09_c92e_4bb7_a2ecabeafcf27813" "{C1F3C015-47B3-4514-9407-AC2E65043419}"
o_stepReturn = ErrGetDataAt(3);
// }} ""
// {{ 252 1 0 "53a14975_dd73_4964_8c8c9f0730a43a7a" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
}   /* end if from skip handler if no error */
// }} ""
// {{{ 5 "iSWAP_Get" "End"
}
...
o_stepReturn = 0;
// }} ""
// {{ 266 1 0 "c9f8030c_ef60_485e_9b279138f7f6da52" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
onerror goto errLabel_22A12BE8BB2146fbB8824DF66137BF6C ;
err.Clear();
// }} ""
// {{ 267 1 0 "bcedff0a_3cba_458a_bedb1a743e5dd0bd" "ML_STAR:{E34155E5-7529-4b6b-AE3E-CDDA40789D55}"
{
	variable arrRetValues[];
...
// }} ""
// {{ 268 1 0 "c9f8030c_ef60_485e_9b279138f7f6da52" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
errLabel_22A12BE8BB2146fbB8824DF66137BF6C : {}
onerror goto 0;
if (err.GetId() != 0)   /* skip handler if no error */
{
// }} ""
// {{{ 269 1 0 "8aeb393a_337d_4788_b25408ee6915eb1c" "{C1F3C015-47B3-4514-9407-AC2E65043419}"
o_stepReturn = ErrGetDataAt(3);
// }} ""
// {{ 270 1 0 "c9f8030c_ef60_485e_9b279138f7f6da52" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
}   /* end if from skip handler if no error */
// }} ""
// {{{ 5 "iSWAP_Place" "End"
}
...
o_stepReturn = 0;
// }} ""
// {{ 254 1 0 "65ac7a80_b8fd_4f3c_a9e6290ec6a707a1" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
onerror goto errLabel_E8A019BC968240cbB4C8B7397BB2F043 ;
err.Clear();
// }} ""
// {{ 255 1 0 "d98672e5_cec6_49ef_92dfdaa4ec2da4f2" "ML_STAR:{862562D1-B5BB-48ce-B5E4-9E37F8ABB61E}"
{
	variable arrRetValues[];
...
// }} ""
// {{ 256 1 0 "65ac7a80_b8fd_4f3c_a9e6290ec6a707a1" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
errLabel_E8A019BC968240cbB4C8B7397BB2F043 : {}
onerror goto 0;
if (err.GetId() != 0)   /* skip handler if no error */
{
// }} ""
// {{{ 257 1 0 "b69dc448_e2ef_4c62_b6dd3535487928f5" "{C1F3C015-47B3-4514-9407-AC2E65043419}"
o_stepReturn = ErrGetDataAt(3);
// }} ""
// {{ 258 1 0 "65ac7a80_b8fd_4f3c_a9e6290ec6a707a1" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
}   /* end if from skip handler if no error */
// }} ""
// {{{ 5 "iSWAP_Move" "End"
}
...
o_stepReturn = 0;
// }} ""
// {{ 260 1 0 "fae9e68f_ea34_4f4d_bb6f62c288b1e7b4" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
onerror goto errLabel_47ED933D92B34914984C5D98423B4C94 ;
err.Clear();
// }} ""
// {{ 261 1 0 "ef5a4036_5d2f_4aae_86e669ef0581597f" "ML_STAR:{86F668D0-478C-41b6-A78B-8B6B8EAA54A7}"
{
	variable arrRetValues[];
...
// }} ""
// {{ 262 1 0 "fae9e68f_ea34_4f4d_bb6f62c288b1e7b4" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
errLabel_47ED933D92B34914984C5D98423B4C94 : {}
onerror goto 0;
if (err.GetId() != 0)   /* skip handler if no error */
{
// }} ""
// {{{ 263 1 0 "974d3165_8b4f_469b_99a59625d159b561" "{C1F3C015-47B3-4514-9407-AC2E65043419}"
o_stepReturn = ErrGetDataAt(3);
// }} ""
// {{ 264 1 0 "fae9e68f_ea34_4f4d_bb6f62c288b1e7b4" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
}   /* end if from skip handler if no error */
// }} ""
// {{{ 5 "iSWAP_Park" "End"
}
...
// }} ""
// {{{ 217 1 0 "05a5dc8c_726f_477e_97f2839edafa8bdd" "{C1F3C015-47B3-4514-9407-AC2E65043419}"
LiquidClassLib::getTipTypeData(tipType, dummy, dummy, dummy, flt_TipLength);
// }} ""
// {{ 218 1 0 "b15f54b8_160d_4d5a_9470d19afc4b0155" "{586C3429-F931-405f-9938-928E22C90BFA}"

// }} ""
// {{ 219 1 0 "a97af8ec_9af3_46fa_a150d41888290f6f" "{B31F3544-5D80-11d4-A5EB-0050DA737D89}"
flt_TipLength_corrected = flt_TipLength - flt_SubmergeDepthCORE;
// }} ""
// {{{ 220 1 0 "8fc17eb7_3fbb_4a8e_b537d43144e8598c" "{C1F3C015-47B3-4514-9407-AC2E65043419}"
DevGetLabwarePosition(ML_STAR, i_labwareID, flt_X_Coord, flt_Y_Coord, flt_Z_Coord, flt_angle);
// }} ""
// {{ 221 1 0 "31649b83_68f7_49a0_974f7efa6232c07d" "{B31F3543-5D80-11d4-A5EB-0050DA737D89}"
str_ReturnValueH0RH = Translate("");
// }} ""
// {{ 222 1 0 "72f92b7c_2537_40be_bc5fe85726a39b19" "{B31F3543-5D80-11d4-A5EB-0050DA737D89}"
flt_StepSize = 0.005;
// }} ""
// {{ 223 1 0 "b5a3458f_9eea_4501_a6aa86c0556ad194" "ML_STAR:{1FB5DA01-3ACB-11d4-AE1F-0004ACB1DCB2}"
{
	variable arrRetValues[];
...
// }} ""
/* {{ 1 "" "0" */ if(0){  /* }} "" */
// {{{ 224 1 0 "73c2ff19_ed4c_4c45_a9c5b56a6e84b044" "{C1F3C015-47B3-4514-9407-AC2E65043419}"
TrcTrace(Translate("str_ReturnValueH0RH: "), str_ReturnValueH0RH);
// }} ""
/* {{ 1 "" "1" */ } /* }} "" */
// {{{ 225 1 0 "f6fe1f5f_39ae_4b71_83f733a5cf490b66" "{C1F3C015-47B3-4514-9407-AC2E65043419}"
str_FW_Digits = StrRight(str_ReturnValueH0RH, 6);
// }} ""
// {{{ 226 1 0 "9883fcc4_3dcd_4199_816696b3668f733f" "{C1F3C015-47B3-4514-9407-AC2E65043419}"
int_FW_Digits = StrIVal(str_FW_Digits);
// }} ""
// {{ 227 1 0 "b427e920_22bd_492e_8c900ff3a99a649c" "{B31F3544-5D80-11d4-A5EB-0050DA737D89}"
int_Steps_mm = int_FW_Digits * flt_StepSize;
// }} ""
// {{ 228 1 0 "bbe179b4_5c85_4ece_ba3738d8817cdfc5" "{B31F3544-5D80-11d4-A5EB-0050DA737D89}"
int_LLDheight = int_Steps_mm - flt_Z_Coord;
// }} ""
// {{ 229 1 0 "502175ce_b71d_406e_b155fea6f39d0fd0" "{B31F3544-5D80-11d4-A5EB-0050DA737D89}"
o_flt_LastLiquidLevel = int_LLDheight - flt_TipLength_corrected;
// }} ""
/* {{ 1 "" "0" */ if(0){  /* }} "" */
// {{{ 230 1 0 "3bcc328b_1906_4590_94e64b4e80f03d3a" "{C1F3C015-47B3-4514-9407-AC2E65043419}"
...
o_stepReturn = 0;
// }} ""
// {{ 232 1 0 "641377bb_9666_411c_91a21acd4e345a9d" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
onerror goto errLabel_1F6E37B4AFEE4395A984238DCEB0E91C ;
err.Clear();
// }} ""
// {{ 233 1 0 "c616f5ea_baed_4075_a75531e82e045e2b" "ML_STAR:{1FB5DA01-3ACB-11d4-AE1F-0004ACB1DCB2}"
{
	variable arrRetValues[];
...
// }} ""
// {{ 234 1 0 "641377bb_9666_411c_91a21acd4e345a9d" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
errLabel_1F6E37B4AFEE4395A984238DCEB0E91C : {}
onerror goto 0;
if (err.GetId() != 0)   /* skip handler if no error */
{
// }} ""
// {{{ 235 1 0 "305af0e7_7bac_4678_a0d1c7c3dd9900d0" "{C1F3C015-47B3-4514-9407-AC2E65043419}"
o_stepReturn = ErrGetDataAt(3);
// }} ""
// {{ 236 1 0 "641377bb_9666_411c_91a21acd4e345a9d" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
}   /* end if from skip handler if no error */
// }} ""
...
// }} ""
// {{ 238 1 0 "bd83dcea_1e69_4096_ada97e91985fe887" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
onerror goto errLabel_F7A233121EBD413184BEE5D2CD3510CA ;
err.Clear();
// }} ""
// {{{ 239 1 0 "7484a06f_e352_4e50_ba49b2ae66740aa9" "{C1F3C015-47B3-4514-9407-AC2E65043419}"
...
{
// }} ""
// {{ 241 1 0 "bd83dcea_1e69_4096_ada97e91985fe887" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
}   /* end if from skip handler if no error */
// }} ""
...
// }} ""
// {{ 243 1 0 "5c89ffd7_d851_4fe5_9e0f7c9c037a5420" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
onerror goto errLabel_0D6035D57CBB40aa9CA31080E8506D64 ;
err.Clear();
// }} ""
// {{{ 244 1 0 "dc47af4b_38a7_4669_a34ededd16ef3599" "{C1F3C015-47B3-4514-9407-AC2E65043419}"
...
{
// }} ""
// {{ 246 1 0 "5c89ffd7_d851_4fe5_9e0f7c9c037a5420" "{3293659E-F71E-472f-AFB4-6A674E32B114}"
}   /* end if from skip handler if no error */
// }} ""
...
// }} ""
// $$author=stefa$$valid=0$$time=2021-05-13 12:30$$checksum=cf5ba9b2$$length=084$$